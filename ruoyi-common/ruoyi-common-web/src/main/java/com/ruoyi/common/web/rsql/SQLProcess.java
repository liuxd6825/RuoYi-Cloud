...
import static com.ruoyi.common.web.rsql.Process.parse;
import static com.ruoyi.common.web.rsql.Utils.asFieldName;
...
public class SQLProcess implements IProcess {
    ...
    public static String Parse(String tenantId, String rsql) throws Exception {
        SQLProcess process = new SQLProcess(tenantId);
        Process.parse(rsql, process);
